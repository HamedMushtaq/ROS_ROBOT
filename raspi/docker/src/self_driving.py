    ...
    def main(self):
        while self.is_running:
            ...
            if self.start:
                ...
                if 0 < self.park_x and 135 < self.crosswalk_distance:
                    ...
                    if not self.start_park and 180 < self.crosswalk_distance:  # When the robot is close enough to the crosswalk, it will start parking
                        ...
                        if self.count_park >= 15:  
                            self.mecanum_pub.publish(Twist())  # 停止移动
                ...
                if lane_x >= 0 and not self.stop:  # 如果检测到车道线，并且车辆没有停止
                    if lane_x > 150:  # 如果线偏离车道中心，进入转弯处理
                        self.count_turn += 1
    ...
    def get_object_callback(self, msg):
        ...
        if self.objects_info == []:  # If it is not recognized, reset the variable
            ...
            for i in self.objects_info:
                ...
                elif class_name == 'red' or class_name == 'green':  # obtain the center coordinate of the parking sign
